...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function [D_lambda,D_S,QNR_index,SAM_index] = indexes_evaluation_FS(I_F,I_MS_LR,I_PAN,L,th_values,I_MS,sensor,tag,ratio)
...
%  I_F_D = MTF(I_F,sensor,ratio);
% SAM_index = SAM(I_MS_LR,I_F_D);
SAM_index = SAM(I_MS,I_F_D);
% SAM_index = 0;
